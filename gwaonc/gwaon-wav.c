                 ...
                 const gchar * font)
{
   ...
   extern double octave_removal_factor; /* experimental */
                ...
                int flag_spg)
{
   ...
   bottom_spec = WIN_wav_height * 3 / 16;
   height_spec = WIN_wav_height * 3 / 16;

   bottom_phase = WIN_wav_height * 9 / 32;
   height_phase = WIN_wav_height * 3 / 32;

   bottom_spg = WIN_wav_height * 29 / 32;
   height_spg = WIN_wav_height * 5 / 8;

   bottom_wav = WIN_wav_height;
   height_wav = WIN_wav_height * 3 / 32;
...
b_fft_up_press_event (GtkWidget * widget, gpointer data)
{
   ...
   update_win_wav (GTK_WIDGET (data), 1, /* spec */ 0, /* wav */ 1  /* spg */);
   return TRUE;
}
...
create_wav (void)
{
   ...
   GtkWidget * b_stop;
   GtkWidget * b_mode_up;
   GtkWidget * b_fft_down;
   GtkWidget * b_fft_up;
   GtkWidget * b_window_up;
   GtkWidget * b_hop_down;
   GtkWidget * b_hop_up;
   GtkWidget * b_lock;
   GtkWidget * b_spacing;
   GtkWidget * b_close;
   ...
   pitch_vbox = gtk_vbox_new (FALSE, 0);
