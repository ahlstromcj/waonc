...
dnl Based off of SOX's sndfile.m4 and SOX_PATH_SNDFILE
...
dnl
dnl AC_SNDFILE([ACTION-IF-FOUND [, ACTION-IF-NOT-FOUND]])
dnl Test for libsndfile, and define SNDFILE_CFLAGS and SNDFILE_LIBS
