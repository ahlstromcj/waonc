...
dnl Based off of SOX's samplerate.m4 and SOX_PATH_SAMPLERATE
dnl Tweaked by Chris Ahlstrom
dnl
...
dnl
dnl AC_SAMPLERATE([ACTION-IF-FOUND [, ACTION-IF-NOT-FOUND]])
dnl Test for libsamplerate, and define SAMPLERATE_CFLAGS and SAMPLERATE_LIBS

AC_DEFUN([AC_SAMPLERATE],
[dnl
